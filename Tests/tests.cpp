...
// Teszt: Sz�rnyeket t�rol� vektor tartalmaz elemeket
...
// Teszt: Sz�rnyeket t�rol� vektor objektumai megfelel� �rt�kekkel vannak-e ell�tva
...
TEST(BossTest, BossStatsPositive) {
    ...
    for (int i = 0; i < allBosses.size(); i++) {
        ...
        EXPECT_TRUE(allBosses[i].fileName.length() > 0);
    }
}

// Teszt: �rukat t�rol� vektor tartalmaz-e elemeket
...
// Teszt: �rukat t�rol� vektor objektumai megfelel� �rt�kkel vannak-e ell�tva
...
// Teszt: Debuffokat t�rol� vektor tartalmaz-e elemeket
...
// Teszt: Debuffokat t�rol� vektor objektumai megfelel� �rt�kkel vannak-e ell�tva
